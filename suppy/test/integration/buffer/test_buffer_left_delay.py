...
def test_buffer_left_delay():
    ...
    transport_buffer_stream = ResourceStream(transport_atomic, buffer_atomic)
    ...
    transport_atomic.register_output_stream(transport_buffer_stream)

    buffer_atomic.register_input_stream(transport_buffer_stream)
